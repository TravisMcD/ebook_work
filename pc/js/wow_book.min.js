...
window.Modernizr = function (d, r, t) {
    ...
    var c = ["Webkit", "Moz", "O", "ms"],
        ...
        e = [],
        f = e.slice,
		h, g = function (a, b, c, e) {
            var d, j, f, g = r.createElement("div"),
                h = r.body,
                v = h ? h : r.createElement("body");
        ...
        var c = f.call(arguments, 1),
            e = function () {
                if (this instanceof e) {
                    ...
                    var d = new d,
                        j = b.apply(d, c.concat(f.call(arguments)));
    ...
    var x = [, "csstransforms3d"],
        n = [, ["@media (", d.join("transform-3d),("), "modernizr){#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join("")].join(""),
        q = x.length;
    g(n, function (a) {
        a = a.childNodes;
    ...
    for (var p in a) v(a, p) && (h = p.toLowerCase(), l[h] = a[p](), e.push((l[h] ? "" : "no-") + h));
    b.cssText = "";
...
(function (d, r, t) {
    ...
    var c = function () {
            var a = u(),
                b = h(e);
            a !== e ? (f(e = a, b), d(r).trigger("hashchange")) : b !== e && (location.href = location.href.replace(/#.*/, "") + b);
    ...
    if (d.browser.msie && !b) {
        ...
        m.start = function () {
            g || (s = (s = d.fn.hashchange.src) && s + u(), g = d('<iframe tabindex="-1" title="empty"/>').hide().one("load", function () {
                ...
                try {
                    "title" === event.propertyName && (g.document.title = k.title)
                } catch (a) {}
            })
        };
        m.stop = a;
        ...
        f = function (a, b) {
            var c = g.document,
                e = d.fn.hashchange.domain;
            a !== b && (c.title = k.title, c.open(), e && c.write('<script>document.domain="' + e + '"\x3c/script>'), c.close(), g.location.hash = a)
        }
    }
    l = m
})(jQuery, this);
(function (d) {
    function r(a, b) {
        ...
        this.pageLoadedCompleted = b.onLoadComplete;
        this.progressEvent = b.progressEvent;
		//alert(b.flipSound+"--"+b.jumpPage);
		this.jumpPage=b.jumpPage;
		
        d.wowBook.support.filters = "filters" in a[0];
        a.addClass("wowbook");
        "static" === a.css("position") && a.css("position", "relative");
        var j = a.children(),
            e = this.pagesContainer = this.origin = d("<div class='wowbook-origin'></div>").css({
                position: "absolute"
            }).appendTo(a);
        ...
        c.internalShadow = d(".wowbook-shadow-internal", e);
        ...
        Modernizr.csstransforms3d && (j = d("<div>").css("transform", "perspective(1px)"), this.perspectiveUnit = "none" != j.css("transform") ? "px" : "", j = null);
        ...
        a.hover(function () {
            if (c.pauseOnHover) {
                h = c.slideShowTimer;
                var a = d(c.opts.controls.slideShow),
                    b = a.hasClass("wowbook-disabled");
                c.stopSlideShow();
        ...
        if (b.deepLinking && this.getLocationHash()) {
            var g;
            try {
				//console.log("selectPage--"+c.selectorToPage("#" + this.getLocationHash()))
                g = c.selectorToPage("#" + this.getLocationHash())
            } catch (s) {}
            void 0 === g && (g = c.locationHashToPage());
            "number" === typeof g && (c.startPage = g, u(c.elem) || c.elem[0].scrollIntoView())
        }
    ...
    function u(a) {
        ...
        return c.top > j && c.top + a.height() < j + b
    }
    function k(a, b, c) {
        var j, e, f, h;
        j = e = 0;
        if (!d.wowBook.support.boxSizing) {
            ...
            e = parseFloat(a.css("paddingLeft")) + parseFloat(a.css("paddingRight")) + h + e;
    ...
    r.prototype = {
        setDimensions: function (a, b) {
            ...
            for (var f, h = !1, g = 0, s = this.pages.length; g < s; g++) this.pages[g].css({
                width: this.pageWidth,
                height: this.pageHeight,
                left: h ? 0 : this.pageWidth
            }), h = !h, f = d(".wowbook-page-content", this.pages[g]), k(f, this.pageWidth, this.pageHeight);
            ...
            this.clipBoundaries && (e = Math.sqrt(this.pageWidth * this.pageWidth + this.pageHeight * this.pageHeight), e = [this.pageHeight - e, c.width(), e, 0], this.origin.css("top", -e[0]), d(".wowbook-inner-clipper", c).css({
                width: "100%",
                height: e[2] - e[0],
                top: e[0]
            }), this.clipper.css({
        ...
        insertPages: function (a, b) {
            ...
            //for (var c = 0, d = bookPages_arr.length; c < d; c++){ 
             	//this.insertPage(a[c], !0);
             //}
            this.createBookPage(bookPages_arr[pageLoadCount]);
			console.log(pageLoadCount);
        },
        createBookPage:function(pagePath){
           var _div = document.createElement('div');
           console.log('page'+pageLoadCount);
           _div.setAttribute('id','page'+pageLoadCount);
           var _iframe = document.createElement('iframe');
           _iframe.setAttribute('width','100%');
           _iframe.setAttribute('height','100%');
           _iframe.setAttribute('src','pages/'+pagePath);
           _iframe.onload = this.pageOnload;
           _div.appendChild(_iframe);
           this.insertPage(_div,!0);
        },
        ...
        pageOnload:function(){
           if(pageLoadCount < (bookPages_arr.length-1))
           {
	           	pageLoadCount++;
	           	_stage.createBookPage(bookPages_arr[pageLoadCount]);
	           	_stage.progressEvent(pageLoadCount,bookPages_arr.length-1);
           }
           else
           {
           		_stage.updateBook(true)
             _stage.pageLoadedCompleted();
           }
        },
        ...
        updateBook: function (a) {
            ...
            this.findPagesType();
            this.positionBookShadow();
            for (var b = !1, c, d = 0, e = this.pages.length; d < e; d++) c = this.pages[d].toggleClass("wowbook-left", b).toggleClass("wowbook-right", !b).data({
                pageIndex: d,
                holded: !1
            }), c.pageIndex = d, b = !b;
            this.findSections();
        ...
        showPage: function (a, b) {
            ...
            for (var c = a - (1 - a % 2), j = c + 1, e = this.pageWidth, f = !1, h, g, s = 0, v = this.pages.length; s < v; s++) h = f ? s : v - s, g = this.transparentPages ? f ? s <= c ? "block" : "none" : s >= j ? "block" : "none" : s === c - 2 || s === c || s === j || s === j + 2 ? "block" : "none", this.pages[s].data("zIndex", h).css({
                display: g,
                left: f ? 0 : e,
                top: 0,
                zIndex: h
			...
			this.toggleControl("jumpPage", h);
			
			if(firstCall == 1){
			onPageBeforeUpdate();
			}
			
            if ((f = this.onShowPage) && d.isFunction(f) && !this.isOnPage(a)) f(this, this.pages[a], a), (h = this.otherPage(a)) && f(this, this.pages[h], h);
            this.currentPage = a; //111
        ...
        holdPage: function (a, b, c, d, e) {
            ...
            if (a) {
                var f = a.data("pageIndex"),
                    ...
                    g = this.pageIsOnTheLeft(h);
                if (d) {
                    if (!this.corners[d] || (this.pageIsOnTheLeft(f) ? /r/ : /l/).test(d)) return
        ...
        foldPage: function (a, b, c, d, e) {
            ...
            if (e && e.length) {
                ...
                if (this.shadows && 0 < k) {
                    var r = 2 * Math.sqrt(g * g + s * s),
                        u = -(r - s) / 2,
                        y = m + parseFloat(a.css("left"));
                ...
                this.foldGradient && 0 < k ? (e = 2 * Math.sqrt(g * g + s * s), this.foldGradientContainer.appendTo(f), this.foldGradientContainer.css({
                    opacity: k,
                    position: "absolute",
                    left: g - d - this.foldGradientElem.width() / 2,
                    top: n - e / 2,
                    width: this.foldGradientElem.width(),
                    height: e,
                    transform: "rotate(" + -q + "deg)"
                }), this.foldGradientElem.css({
                    left: -b + this.foldGradientElem.width() / 2,
                    height: e
        ...
        holdHardpage: function (a, b, c, j, e) {
            ...
            if (e && e.length) {
                ...
                e > g && (e = g);
                e < -g && (e = -g);
                var l = -Math.sqrt(1600 * (1 - e * e / ((g + 15) * (g + 15)))),
                    h = Math.abs(e / g),
                    l = 1 == h ? 0 : Math.atan2(l, e);
                if (this.opts.use3d && Modernizr.csstransforms3d) {
                    ...
                    if (this.animating) if (f = this._animationData, this.curledPage || f.curled) {
                        ...
                        roty = f.angle.from - f.angle.delta * (f.from.x - b) / f.dx
                    } else Math.abs(b - f.from.x) > Math.abs(f.dx / 2) && (f.angle || (f.angle = {
                        from: roty,
                        to: 0,
                        delta: -roty,
                        fromx: b,
                        dx: f.to.x - b
                    }), roty = f.angle.from - f.angle.delta * (f.angle.fromx - b) / f.angle.dx);
                    ...
                    c.css({
                        ...
                        transformOrigin: j + "px 50%",
                        display: "block",
                        zIndex: 1E3
                    })
                } else c.css({
                    transform: "skewY(" + l + "rad) scaleX(" + h + ")",
                    transformOrigin: (f ? j : g - j) + "px 50%",
                    display: "block",
                    zIndex: 1E3
                });
                !d.wowBook.support.transform && d.wowBook.support.filters && (b = "M11=" + h + ", M12=0, M21=" + Math.tan(l) * h + ", M22=1", c.css("filter", "progid:DXImageTransform.Microsoft.Matrix(" + b + ", sizingMethod='auto expand')"), c.css({
                    marginTop: k - c.height(),
                    marginLeft: a ? g - c.width() : 0
                }));
                this.shadows && this.hardPageShadow.css({
                    display: "block",
                    left: a ? 0 : g,
                    opacity: 0.5 * Math.abs(e / g)
                })
            }
        },
        ...
        foldPageBasic: function (a, b, c, d, e) {
            ...
            void 0 === e && (e = this.backPage(f));
            if (e && e.length) {
                var f = this.pageWidth,
                    k = this.pageHeight,
                    l = this.foldGradientElem.width(),
                    m = this.foldShadow.width();
                d || (d = "tl");
                if (!a.data("foldPageBasic")) {
                    ...
                    this.foldShadow.css({
                        ...
                        transform: "",
                        top: 0
                    }).toggleClass("wowbook-shadow-fold-flipped", h);
                    ...
                    this.foldGradientElem.css({
                        left: 0,
                        height: k
                    }).toggleClass("wowbook-fold-gradient-flipped", h)
                }
                a.data("holdedAt", {
                    x: b,
                    y: c
                ...
                h > 2 * f && (h = 2 * f);
                b = h / 2;
                g ? (c = "rect(-1000px 1000px 1000px " + b + "px)", d = "rect(-1000px 1000px 1000px " + (f - b) + "px)", h -= f) : (c = "rect(-1000px " + (f - b) + "px 1000px -1000px)", d = "rect(-1000px " + b + "px 1000px -1000px)", h = f - h + f);
                a.css("clip", c);
                e.css({
                    clip: d,
                    left: h,
                ...
                this.shadows && 0 < a ? (e = g ? b - m : f - b + f, this.shadowContainer.css("opacity", a), this.foldShadow.css({
                    left: e,
                    display: "block"
        ...
        releasePage: function (a, b, c, d) {
            ...
            if (b && f) this.animateFoldPage(a, h, f, {
                x: this.corners[h][0],
                y: this.corners[h][1]
            }, function () {
                e.releasePage(a, !1, c)
                ...
                foldPageBasic: null,
                holded: !1
            }), this.clipBoundaries && !this.zoomed && (this.clipper.css("overflow", "hidden"), this.clipper.children(".wowbook-inner-clipper").css("overflow", "hidden")), this.shadowClipper.css("display", "none"), this.internalShadow.parent().hide(), this.foldGradientContainer.hide(), this.hardPageShadow.hide(), this.resetPage(a), c && c.length && (this.resetPage(c), c.hide()), this.foldShadow.removeClass("wowbook-shadow-fold-flipped").css({
                transform: "",
                left: ""
        ...
        gotoPage: function (a, b) {
            ...
            if (!this.animating && ("string" === typeof a && "#" == a.charAt(0) && (a = this.selectorToPage(a)), 0 > a && (a = 0), a > this.pages.length - 1 && (a = this.pages.length - 1), !this.isOnPage(a))) {
                var c = a < this.currentPage,
                    d = this,
                    e = c ? d.leftPage() : d.rightPage();
                if (e) {
                    this.uncurl(!0);
                    var f, h;
                    c ? (f = this.leftPage(a), h = this.rightPage(a)) : (f = this.rightPage(a), h = this.leftPage(a));
                    if (c) for (var g = e.pageIndex - 1; 0 <= g; g--) this.pages[g].css("display", "none");
                    else for (var g = e.pageIndex + 1, k = this.pages.length; g < k; g++) this.pages[g].css("display", "none");
		...
		resizePage:function(_width,_height){
        ...
        fillToc: function (a, b) {
            ...
            if (0 !== c.length) {
                ...
                for (var h = 0, g = j.length; h < g; h++) e = j[h], e = b.replace(/\$\{link\}/g, "#" + this.id + "/" + e.id.substr(1)).replace(/\$\{section\}/g, e.title).replace(/\$\{page\}/g, e.page), d(e).appendTo(c).wrap(f)
            }
        },
        ...
        zoom: function (a) {
            ...
            if (a !== this.zoomLevel) {
                ...
                var j = this,
                    ...
                    l = Math.min(h, g),
                    m = Math.min(f, k),
                    n = (2 * this.pageWidth - l) / 2,
                    q = (this.pageHeight - m) / 2;
                b.css({
                    width: l,
                    height: m,
                    left: n,
                ...
                this.zoomContentOverflowed = h > g || f > k;
                var p = b.offset(),
                    e = e[0] !== window ? e.offset() : {
                        left: e.scrollLeft(),
                        top: e.scrollTop()
                    };
                p.right = p.left + l;
                ...
                e.bottom < p.bottom && c.css("marginTop", (parseFloat(c.css("marginTop")) || 0) + (p.bottom - e.bottom));
                l === h && c.css("marginLeft", 0);
                m === f && c.css("marginTop", 0);
                d.wowBook.support.transform ? c.css({
                    transform: "scale(" + a + ")",
                    transformOrigin: "0 0"
                }) : c.css("zoom", a);
				/*--- Change for Zoom Box Hidden -- */
               /* 1 === this.zoomLevel ? (b.unbind("mousemove.wowbook").css({
                    ...
                    marginLeft: 0,
                    marginTop: 0
                })) : (this.clipBoundaries && this.clipper.css("overflow", "visible"), b.css("overflow", "hidden"), this.zoomed || b.bind("mousemove.wowbook", function (a) {
                    j.zoomedAt(a)
                }));*/
        ...
        zoomedAt: function (a) {
            if (this.zoomContentOverflowed) {
                var b = this.zoomLevel,
                    c = this.zoomWindow.offset(),
                    j = a.pageX - c.left;
                a = a.pageY - c.top;
                var e = this.zoomWindow.width(),
                    c = 2 * this.pageWidth * b - e,
                    j = j / e,
                    e = this.zoomWindow.height(),
                    f = this.pageHeight * b - e;
                adjust = d.browser.ie8 ? b : 1;
                this.zoomContent.css({
                    marginLeft: -c * j / adjust,
                    marginTop: -f * (a / e) / adjust
                })
            }
        },
        positionBookShadow: function () {
            var a = this.pages.length,
                b = !(!this.opts.bookShadow || this.zoomed || !a || 3 > a && this.holdedPage);
            this.bookShadow.toggle(b);
            if (b) {
                var b = this.pageWidth,
                    c = this.currentPage,
                    d = this.holdedPageBack && this.holdedPageBack.pageIndex,
                    e = d && this.pageIsOnTheLeft(d),
                    c = 0 < c,
                    f = this.rightPage(),
                    c = !c || 0 === d,
                    a = !f || d === a - 1 && e,
        ...
        createAudioPlayer: function (a, b) {
            ...
            for (var c = [], j = 0, e = b.length; j < e; j++) c.push('<source src="' + a + b[j] + '">');
    ...
    var l = d.browser.msie && 9 > d.browser.version ? 1 : 0,
        m = {
            thin: 2 - l,
            medium: 4 - l,
            thick: 6 - l
...
(function (d) {
    ...
    if (d.event.fixHooks) for (var u = t.length; u;) d.event.fixHooks[t[--u]] = d.event.mouseHooks;
    d.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener) for (var d = t.length; d;) this.addEventListener(t[--d], r, !1);
            else this.onmousewheel = r
        },
        teardown: function () {
            if (this.removeEventListener) for (var d = t.length; d;) this.removeEventListener(t[--d], r, !1);
...
(function (d) {
    ...
    if (d.cssHooks) {
        ...
        d.each(["transform", "transformOrigin"], function (k, l) {
            d.wowBook.support[l] && (d.wowBook.support[l] !== l && !d.cssHooks[l]) && (d.cssHooks[l] = {
                get: function (k) {
        ...
        d.wowBook.applyAlphaImageLoader = function (k) {
            var l, m, a, b, c = "",
                j = d("<div style='display:none'></div>").appendTo("body");
            m = 0;
            for (a = k.length; m < a; m++) if (b = k[m], j.addClass(b), l = j.css("background-image").match(/^url\("(.*)"\)$/)) c += "." + b + "{background:none; filter : progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + l[1] + "', sizingMethod='scale'); } ", j.removeClass(b);
